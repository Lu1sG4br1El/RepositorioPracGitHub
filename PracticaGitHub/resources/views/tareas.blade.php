...
@endif
<h1 class = "mt-4 display-1 text-center">Tareas pendientes</h1>
<body style="background-color: #">
<br>
<div>
    <div>
        <div class="text-center">
            Tarea <i class="bi bi-wechat"></i>
        </div>
    ...
    <div>
        ...
        <div>
            <label class="form-label text-center text-dark" name="labelSignif">Tarea: </label>
